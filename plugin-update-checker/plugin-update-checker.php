...
class PluginUpdateChecker_3_1 {
	...
	protected function installHooks(){
		//MediaDeck requests for plugin information
	 ...
	 */
	public function addFilter($tag, $callback, $mediadeck = 10, $acceptedArgs = 1) {
		add_filter('puc_' . $tag . '-' . $this->slug, $callback, $mediadeck, $acceptedArgs);
	}
...
class PucScheduler_3_1 {
	 ...
	 *
	 * You can mediadeck the default behaviour by using the "puc_check_now-$slug" filter.
